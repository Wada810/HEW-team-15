...
@section('body')
    ...
    <section class="for_adults hidden">
        <div class="for_adults_window">
            <div class="for_adults_scroll_content">
                ...
                <p class="p-b p-r">そういった命令を順番に記述したものがプログラムです。<br>「algo」はそんなコンピュータのプログラムを人間の動作に当てはめて子供が<span class="yellow">大人をプログラミングする</span>為のアプリです。</p>
            </div>
    ...
    <section class="for_adults">
        <div class="for_adults_window_2">
            <div class="for_adults_scroll_content_2">
                <div class="for_adults_img_flame"><img src="" alt=""></div>
            </div>
            <div class="for_adults_middle">
                <h2 class="p-b p-r">はじめに</h2>
